...
| 2026-04-27 | Note: Kalshi crypto perps ("Timeless") launched 2026-04-27 as second viable hedge venue | Polymarket also launched perps mid-April. CFTC-regulated US venue removes the offshore-only constraint that originally pinned hedging to Hyperliquid; venue-selection is now an open question when this overlay is built. See [`reference/external-landscape.md`](../reference/external-landscape.md) |
